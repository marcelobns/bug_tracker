<div class="bugs form col-md-9">
    ...
    <fieldset>
        ...
        echo $this->Form->input('origin_id', array('value'=>@$origin_id, 'empty'=>__('Select an Item...'), 'class'=>'combobox'));
        ...
        echo $this->Form->input('technician_id', array('multiple'=>true, 'label'=>__('Technician'), 'size'=>'1'));
        echo $this->Form->input('deadline', array('type'=>'text', 'class'=>'date_picker'));
        echo $this->Form->hidden('BugTracker.situation_id', array('value'=>$situation_open));
        ?>
