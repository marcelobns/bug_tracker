<div class="bugTrackers form col-md-9">
    <?php echo $this->Form->create('BugTrack'); ?>
    <fieldset>
        ...
        <?php $technician_id = $this->request->data['BugTrack']['technician_id'][0] ? $this->request->data['BugTrack']['technician_id'] : $this->Session->read('Auth.User.id'); ?>
        <?php echo $this->Form->input('technician_id', array('multiple'=>true, 'label'=>__('Technician'), 'value'=>$technician_id, 'class'=>'selectize')); ?>
